...
/**
 * Servlet implementation class DownloadScreenshotServlet
 */
@WebServlet("/downloadScreenshot")
public class DownloadScreenshotServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DownloadScreenshotServlet() {
        super();
