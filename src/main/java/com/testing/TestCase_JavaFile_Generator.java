...
public class TestCase_JavaFile_Generator {
	private static final String FILE_NAME = "GeneratedTestCases.java";
	 ...
	 public static File generateTestCaseFile(List<String> executedMethods, String testUrl) {
		 ...
		 try (FileWriter writer = new FileWriter(file)) {
	            ...
	            writer.write("        System.setProperty(\"webdriver.chrome.driver\", \"path_to_chromedriver\");\n");
	            writer.write("        WebDriver driver = new ChromeDriver();\n\n");
	            writer.write("        driver.get(\"" + testUrl + "\");\n\n");

	            writer.write("        GeneratedTestCases testCases = new GeneratedTestCases();\n\n");
